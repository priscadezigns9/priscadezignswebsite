...
- **Sales Signal Mandate (Marketplace Shift):** The Autodrome is now being positioned as a **Luxury Vehicle Marketplace**. Every relay from primary sources (Ferrari, Lamborghini, Bugatti, etc.) must be framed to build dealership authority. Prioritize official pricing, limited edition availability, and "Sales Signal" assets that signal a brokerage-ready environment.
