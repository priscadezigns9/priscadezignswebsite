...
const PKGS={
  standard:[
    ...
    {name:"Growth",price:"$597 TTD",desc:"Manage 1 Brand Page · Full Branding & App/Web Lead Strategisture · Content Creation & Copywriting · Advanced SEO & Analytics · 1 Month Free Maintenance"},
    {name:"Trusted",price:"$1,200 TTD",desc:"Full Website Lead Strategisture (10-15 Pages) · Premium Brand Scaling & PR · 24/7 Priority Tech Support · Technical SEO & SSL · 1 Month Free Maintenance"},
    {name:"Custom",price:"Bespoke",desc:"Tailored Digital Lead Strategisture · Custom API & Tool Integration · Unique Brand Identity Design · Scalable Infrastructure · Priority Sovereign Support"}
  ],
  ecommerce:[
    ...
    {name:"E-Growth",price:"$1,497 TTD",desc:"2-5 Page Store Lead Strategisture · Full Shop Logic (10+ Products) · Deep Copywriting & Product SEO · Automated Fulfillment Sync · 1 Month Free Maintenance"},
    {name:"E-Trusted",price:"$2,500 TTD",desc:"Elite Store (50+ Products) · 15+ Page Network Lead Strategisture · Advanced Inventory & CRM Automation · On-Chain Inventory Logic · 1 Month Free Maintenance"}
  ],
  ai:[
...
const STEPS={
  ...
  templates_chatbot:{
    bot:"The chatbot add-on ($49.99 USD one-time setup) answers your business FAQs 24/7 - pricing, services, hours, how to book. Monthly: $49.99 USD/mo (hosting + SSL + updates + bot).",
    r:[
