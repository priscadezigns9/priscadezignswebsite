(function(){
    ...
    .cmsg.usr { background: var(--cb-purple); color:var(--cb-text); align-self:flex-end; border-bottom-right-radius: 4px; border: 1.5px solid rgba(30,27,75,0.12); box-shadow: 0 4px 15px rgba(0,0,0,0.06); font-weight: 500; }
    ...
    if(!document.getElementById('pd-roadmap-bar')){
        ...
        r.innerHTML = `
            <style>
                ...
                .road-btn:hover { background:var(--cb-text); color:#fff; border-color:var(--cb-text); transform: translateY(-2px); box-shadow: 0 8px 20px rgba(30, 27, 75, 0.2); }
                @media (max-width: 520px) {
...
const STEPS = {
    ...
    "drew_start": {
        ...
        "r": [
            ...
            { "l": "Small business tools", "s": "smallbiz_tools", "i": "tool" },
            { "l": "Agency Packages", "s": "pkg_menu", "i": "package" }
        ]
    },
    "smallbiz_tools": {
        "bot": "Four simple, affordable tools built for small businesses — each one designed, configured, and launched for you:",
        "r": [
            { "l": "WhatsApp Ordering Page", "s": "whatsapp_orderflow", "i": "shopping-bag" },
            { "l": "Appointment Booking Page", "s": "appt_booking", "i": "calendar" },
            { "l": "Business Docs Generator", "s": "business_docs", "i": "layout" },
            { "l": "Food Order & Delivery Tracker", "s": "food_tracker", "i": "shopping-bag" },
            { "l": "← Back", "s": "drew_start", "i": "arrow-left" }
        ]
    },
    "food_tracker": {
        "bot": "The Food Order & Delivery Tracker is a simple, phone-friendly order board for food businesses — record orders, move them from New to Preparing to Out for Delivery to Delivered, track payment status, and share orders by WhatsApp or email. Export Word or CSV backups any time. Local-first, no account or dashboard login needed.\n\nThis is a newer product — pricing isn't published yet, so message us on WhatsApp for current pricing and next steps.",
        "wa": true
    },
    "whatsapp_orderflow": {
        "bot": "The WhatsApp Ordering Page is a branded page for up to 10 products or services — customers browse, build their order, and send it straight to your WhatsApp. Built for food, clothing, beauty, retail, and other small businesses that don't need a full online store.\n\nUS$197 one-time setup + US$20/month maintenance. A 50% deposit reserves your project slot.",
        "r": [
            { "l": "Get started", "s": "talk", "i": "message-circle" },
            { "l": "← Back", "s": "smallbiz_tools", "i": "arrow-left" }
        ]
    },
    "appt_booking": {
        "bot": "The Appointment Booking Page gives customers one clear place to choose a service, request a date and time, and share their details — for up to 10 services, branded to your business. You review and confirm each request, so you stay in control.\n\nUS$150 one-time setup + US$15/month maintenance.",
        "r": [
            { "l": "Get started", "s": "talk", "i": "message-circle" },
            { "l": "← Back", "s": "smallbiz_tools", "i": "arrow-left" }
        ]
    ...
    "business_docs": {
        "bot": "Business Docs Generator brings 7 branded business documents into one simple workspace: Quotes/Estimates, Invoices, Receipts, Pro Forma Invoices, Purchase Orders, Delivery Notes, and Credit Notes. Includes your branding/logo, document fields and layout setup, and WhatsApp/email sharing.\n\nUS$125 one-time setup + US$10/month optional maintenance.",
        "r": [
            { "l": "Get started", "s": "talk", "i": "message-circle" },
            { "l": "← Back", "s": "smallbiz_tools", "i": "arrow-left" }
        ]
    ...
    "need_website": {
        ...
        "r": [
            { "l": "Just a landing page — $75", "s": "pkg_landing", "i": "zap" },
    ...
    "pkg_landing": {
        "bot": "Our Landing Page is the fastest, most affordable way to get a focused offer or campaign online. US$75 flat — maximum 2 sections, mobile-ready design, a clear call-to-action, and 1 revision included.",
        "r": [
            { "l": "Let's get started", "s": "talk", "i": "zap" },
            { "l": "I need it in 24hrs instead — $200", "s": "pkg_oneday", "i": "zap" },
    ...
    "pkg_menu": {
        ...
        "r": [
            { "l": "Landing Page — $75", "s": "pkg_landing", "i": "zap" },
    ...
    "automation": {
        ...
        "r": [
            ...
            { "l": "AI Employees (10 departments)", "s": "aidata_products", "i": "database" },
    ...
    "pkg_aidata": { "bot": "AI Employees — hire specialist AI staff across 10 departments (Admin, HR, Finance, Health & Safety, IT, Marketing, Quality Assurance, Production, Customer Relations, Sales), most on the same tier pricing (AI Sales is priced separately).", "pkg": "aidata" },
