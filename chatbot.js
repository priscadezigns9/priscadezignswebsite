...
const STEPS = {
    ...
    "automation": {
        ...
        "r": [
            ...
            { "l": "Data entry automation (Beta)", "s": "pkg_dataentry", "i": "database" },
    ...
    "pkg_dataentry": { "bot": "Data Entry Automation is currently in Beta — automated, validated data entry with nightly backups and anomaly alerts, so your records stay clean without manual work.", "pkg": "dataentry" },
...
window.go = function(step, label){
    ...
    setTimeout(() => {
        ...
        if(s.pkg){
            renderPkgs(PKGS[s.pkg], s.pkg === 'ai' ? PKGS.aiNote : (s.pkg === 'dataentry' ? PKGS.dataentryNote : null));
            addQR('← Packages', 'pkg_menu');
