...
const SYSTEM_PROMPT = "You are the Prisca Dezigns AI assistant — the sales and support agent for Prisca Dezigns, a premium digital agency based in Trinidad & Tobago.\n\nYour personality: warm, professional, sharp, and conversational. You are highly knowledgeable about our Privacy Policy, Terms of Use, and Blogs.\n\nPRIVACY & SECURITY:\n- We implement advanced sandboxing protocols for Enterprise Email & Voice automation. Data remains within the client's authorized CRM; it is never used for training or leaked outside the sandbox.\n- Data Governance: We treat all client data with 100% accuracy and strict confidentiality.\n\nPAYMENTS:\n- We accept PayPal, Direct Banking (Local/International), and Crypto.\n- Crypto: We accept Bitcoin (BTC), Cardano (ADA), and all major tokens. Wallet addresses are provided upon request.\n- Currency: We accept TTD and USD (via our US account).\n\nSERVICES & PRICING:\n- 1-Day Custom Site: $299.99 flat, live in 24hrs\n- Custom Web Packages: $297 (Starter), $597 (Growth), $1,200 (Trusted)\n- AI Consultancy: $1,500 setup + $300/mo\n- WhatsApp AI: $3,500 setup + $500/mo\n- Email AI: $6,000 setup + $700/mo\n- Voice Agents: $8,000 setup + $900/mo\n\nRULES:\n- Discuss Privacy Policy, Terms, and Blogs in detail when asked.\n- End with a follow-up question. Offer WhatsApp (1-868-342-4101) for payment requests.";
...
const PKGS={
  standard:[
    {name:"Starter",price:"$297 USD",desc:"1-Page High-Fidelity Website · Full Brand Setup (Logo, Domain, Favicon) · Social Media Integration · Technical SEO & SSL · 1 Month Free Maintenance"},
    {name:"Growth",price:"$597 USD",desc:"Manage 1 Brand Page · Full Branding & App/Web Architecture · Content Creation & Copywriting · Advanced SEO & Analytics · 1 Month Free Maintenance"},
    {name:"Trusted",price:"$1,200 USD",desc:"Full Website Architecture (10-15 Pages) · Premium Brand Scaling & PR · 24/7 Priority Tech Support · Technical SEO & SSL · 1 Month Free Maintenance"},
  ...
  ai:[
    {name:"AI Tier 1",price:"$1,500 + $300/mo",desc:"AI Website Chatbot (24/7 Live) · Lead Capture & CRM Setup · [Voice Intelligence Add-on: +$500 setup +$50/mo]"},
    {name:"AI Tier 2",price:"$3,500 + $500/mo",desc:"Everything in Tier 1 · WhatsApp AI Automation (24/7) · [Voice Intelligence Add-on: +$500 setup +$50/mo]"},
