(function(){
    ...
    :root {
        ...
        --cb-futuristic-bg: rgba(255, 255, 255, 0.98);
    }
...
if('webkitSpeechRecognition' in window || 'SpeechRecognition' in window){
  ...
  recognition.onresult = function(e) {
    ...
    if(inp){
        inp.value = t;
        setTimeout(() => { window.chatSend(); }, 300);
    }
  };
...
function stopMic(){
  ...
  var inp = document.getElementById('chat-inp');
  if(inp && inp.placeholder === "Listening...") inp.placeholder = "Type a message...";
  if(recognition) {
