...
const STEPS = {
    ...
    "business_docs": {
        "bot": "Business Docs Generator brings 7 branded business documents into one simple workspace: Quotes/Estimates, Invoices, Receipts, Pro Forma Invoices, Purchase Orders, Delivery Notes, and Credit Notes. Pricing isn't published yet since it's a new product — message us on WhatsApp for current pricing and setup.",
        "wa": true
    },
    "about": {
