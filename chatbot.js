...
const STEPS = {
    ...
    "automation": {
        ...
        "r": [
            ...
            { "l": "AI Data (records, reporting)", "s": "aidata_products", "i": "database" },
            { "l": "AI Voice (receptionist, sales)", "s": "aivoice_products", "i": "phone" },
            { "l": "AI Channel (email, web, WhatsApp)", "s": "aichannel_products", "i": "globe" },
    ...
    "pkg_ai": {
        "bot": "AI Consultancy at Prisca Dezigns is organized into three Specialized AI Networks. Which one fits what you're trying to automate?",
        "r": [
            { "l": "AI Data (records, reporting)", "s": "aidata_products", "i": "database" },
            { "l": "AI Voice (receptionist, sales)", "s": "aivoice_products", "i": "phone" },
            { "l": "AI Channel (email, web, WhatsApp)", "s": "aichannel_products", "i": "globe" },
    ...
    "pkg_aidata": { "bot": "AI Data — hire specialist AI Employees across 8 departments (Admin, HR, Finance, HSE, IT, Marketing, QA/QC, Production), each on the same tier pricing.", "pkg": "aidata" },
